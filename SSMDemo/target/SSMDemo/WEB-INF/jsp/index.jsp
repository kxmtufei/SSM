            ...
            <div class="container-fluid">
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <!-- Logout    -->
                        <li class="nav-item"><a href="<%=basePath%>/page/login" class="nav-link logout"> <span class="d-none d-sm-inline">Logout</span><i class="fa fa-sign-out"></i></a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                <li class="active"><a href="<%=basePath%>/page/index"> <i class="icon-home"></i>Home </a></li>
                <li><a href="<%=basePath%>/page/table"> <i class="icon-grid"></i>Tables </a></li>
                <li><a href="<%=basePath%>/page/charts"> <i class="fa fa-bar-chart"></i>Charts </a></li>
                <li><a href="<%=basePath%>/page/forms"> <i class="icon-padnote"></i>Forms </a></li>
                ...
                <li><a href="<%=basePath%>/page/login"> <i class="icon-interface-windows"></i>Login page </a></li>
